				...
				<table class="min-w-full divide-y divide-gray-200">
					...
					<tbody class="divide-y divide-gray-200">
						<?php foreach ($equipment_list as $equipment)
							...
							'
								<tr>
									<td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">' . $equipment->id . '</td>
									<td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800">' . $equipment->name . '</td>
									<td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800">' . $equipment->type . '</td>
									<td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800">' . $equipment->status . '</td>
									<td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800">' . $equipment->detail . '</td>
