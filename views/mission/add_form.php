<div class="flex justify-center items-center h-lvh overflow-hidden">
    <div class="w-full max-w-lg">
        <form 
            method="POST" 
            action="?controller=mission&action=add" 
            ...
            <div class="md:mb-4 flex flex-wrap -mx-3">
                <div class="w-full md:w-1/2 px-3 mb-4 md:mb-0">
                    ...
                    <div class="relative">
                        ...
                        <div class="pointer-events-none absolute inset-y-0 right-1 flex items-center px-2">
                ...
                <div class="w-full md:w-1/2 px-3 mb-4 md:mb-0">
                    ...
                    <div class="relative">
                        ...
                        >
                        <?php 
                            foreach($status_list as $status => $style)
                            {
